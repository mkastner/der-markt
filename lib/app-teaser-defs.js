module.exports = {
  ...
  festgeld: {
    title: 'Festgeld %%month%%/%%year%%',
    url: 'https://festgeld.der-markt.com/rechner/dermarkt/schnellcheck.aspx',
    params: [
      {
        label: 'Anlagebetrag',
        key: 'AB',
  ...
  ratenkredit: {
    title: 'Ratenkredite  %%month%%/%%year%%',
    url: 'https://ratenkredit.der-markt.com/dermarkt/schnellcheck.aspx',
    params: [
      {
        label: 'Kreditbetrag',
        key: 'KB',
  ...
  hypothek: {
    title: 'Hypotheken/Baugeld %%month%%/%%year%%',
    url: 'https://hypotheken.der-markt.com/rechner/dermarkt/schnellcheck.aspx',
    params: [
      {
  ...
  bausparen: {
    title: 'Bausparvergleich %%month%%/%%year%%',
    url: 'https://bausparen.der-markt.com/dermarkt/schnellcheck.aspx',
    params: [
      {
        label: 'Bausparsumme',
        key: 'BS',
